...
export const patternToTabs = {
  arrays: {
    test: (props) => <ArrayTest {...props} />,
    video: (props) => <AnimationPlayer {...props} />,
  },
};
...
function ArrayTest({ args, addToolAnimation, name }) {
  ...
  const [inputs, setInputs] = useState(
    Object.entries(args).map(([k, v]) => v.default_value)
  );
    ...
    <div className="validation-content">
      <div className="test-cases">
        ...
        <button
          ...
          type="button"
          className="focus:outline-none text-white bg-green-700  focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
        >
          Test
        </button>
      </div>
