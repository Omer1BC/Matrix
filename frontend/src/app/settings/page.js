    ...
    {user && (
      ...
      <header className="border-b border-primary/20 bg-card/50 backdrop-blur-sm">
        <div className="container mx-auto flex items-center justify-between px-4 py-4">
          ...
          <h1 className="glow-text font-mono text-xl font-bold text-primary">Account Settings</h1>
      ...
      <main className="container mx-auto max-w-4xl px-4 py-12">
        <div className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-primary">Manage your personal details and account settings</p>
          </div>
          ...
          <Card className="matrix-border bg-card/40 p-6 backdrop-blur-sm">
            <div className="space-y-6">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-lg font-semibold text-foreground">Personal Details</Label>
              </div>
          ...
          <Card className="matrix-border bg-card/40 p-6 backdrop-blur-sm">
            <div className="space-y-6">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-lg font-semibold text-foreground">Change Password</Label>
              </div>

              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="currentPassword" className="text-sm text-primary/90">
                    Current Password
                  </Label>
                  <Input
                    id="currentPassword"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword" className="text-sm text-primary/90">
                      Confirm Password
                    </Label>
                    <Input
                      id="confirmPassword"
          ...
          {/* Page Title */}
          <div className="space-y-2">
            <h2 className="text-3xl font-bold text-foreground">Learning Preferences</h2>
            <p className="text-primary">Describe how you learn best so the AI can personalize your guidance</p>
          </div>
          ...
          <Card className="matrix-border bg-card/40 p-6 backdrop-blur-sm">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-lg font-semibold text-foreground">Your Learning Style</Label>
              </div>

              <p className="text-sm text-primary/70">
                Tell us about your learning preferences, strengths, and how you like to approach problem-solving. The AI
                will use this information to provide personalized guidance when you work on LeetCode problems.
              </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-primary/50">
                  Be as detailed as you&aposd like. Include your preferred learning methods, what helps you understand
                  concepts best, and any specific approaches that work well for you.
                </p>
              </div>
            </div>
          </Card>
