...
export default function Header () {
    ...
    const handleLogout = async () => {
        try {
            const response = await fetch("http://localhost:8000/api/logout", {method: "POST"})
            ...
            <div>
                {
                    !user && (
                        <div>
                            <button className="log-in-button" onClick={toggleLogin}>Log in</button>
                            <button className="log-in-button" onClick={toggleSignup}>Sign up</button>
                        </div>
                    )
                }
                {
                ...
                <div className="login-popup-overlay">
                    <div className="login-popup-content">
                        <form className="login-form" onSubmit={handleLogin}>
                            ...
                            <input placeholder="Enter passowrd" onChange={(e) => setPassword(e.target.value)}></input>
