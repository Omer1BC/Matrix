...
class ProblemCategory(models.Model):
    ...
    def is_unlocked_for_user(self, user):
        ...
        previous_category = ProblemCategory.objects.filter(
...
class Problem(models.Model):
    ...
    def is_unlocked_for_user(self, user):
        ...
        previous_problem = Problem.objects.filter(
...
class ProblemCompletion(models.Model):
    ...
    problem = models.ForeignKey(Problem, on_delete=models.CASCADE, related_name='completions')
    ...
    def __str__(self):
        status = "Completed" if self.is_completed else "Attempted" if self.is_attempted else "Not Started"
...
class CategoryPrerequisite(models.Model):
    ...
    category = models.ForeignKey(ProblemCategory, on_delete=models.CASCADE, related_name='prerequisites')
    required_category = models.ForeignKey(ProblemCategory, on_delete=models.CASCADE, related_name='unlocks')
...
class UserProgress(models.Model):
    ...
    current_category = models.ForeignKey(ProblemCategory, on_delete=models.SET_NULL, null=True, blank=True)
    ...
    def update_progress(self):
        ...
        total_points = ProblemCompletion.objects.filter(
            user=self.user,
            is_completed=True
