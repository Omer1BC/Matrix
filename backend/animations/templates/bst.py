...
class BstVisualizer(VGroup):
    ...
    def _update_command_label(self, text, space_complexity="", time_complexity=""):
        ...
        if space_complexity:
            space_text = Text(f"Space: {space_complexity}", font_size=20, color=PALE_GREEN)
    ...
    def delete(self, value, run_time=5):
        ...
        if has_two_children:
            ...
            fade_highlights = AnimationGroup(*[FadeOut(h) for h in highlight_circles], run_time=1.0)
